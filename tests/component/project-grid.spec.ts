...
describe('ProjectGrid.vue', () => {
  it('shows the skeleton while pending', () => {
    const wrapper = mount(ProjectGrid, { props: { projects: [], pending: true } })
  ...
  it('shows the real cards once loaded', () => {
    const wrapper = mount(ProjectGrid, { props: { projects, pending: false } })
